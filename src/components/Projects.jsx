...
const Projects = () => {
  return (
    <section id="projects" className="text-white py-8 px-4 md:px-16">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="flex flex-row justify-between items-center p-4">
                ...
                <a
                  href={project.github}
                  className="transition-colors duration-300 hover:text-yellow-500 cursor-pointer text-gray-400"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
